...
var ResponseMessage = /** @class */ (function () {
    ...
    ResponseMessage.prototype.successResponse = function (data) {
        return {
            message: "success",
            code: 200,
            status: http_status_codes_1.getReasonPhrase(200),
            error: false,
            response: data,
        };
    };
    ResponseMessage.prototype.notFoundResponse = function (message) {
        return {
            message: message,
            code: 404,
            status: http_status_codes_1.getReasonPhrase(404),
            error: true,
            response: null,
        };
    };
    ResponseMessage.prototype.badRequestResponse = function (message) {
        return {
            message: message,
            code: 400,
            status: http_status_codes_1.getReasonPhrase(400),
            error: true,
            response: null,
        };
    };
    ResponseMessage.prototype.serverErrorResponse = function () {
        return {
            ...
            code: 500,
            status: http_status_codes_1.getReasonPhrase(500),
            error: true,
            response: null,
        };
    };
